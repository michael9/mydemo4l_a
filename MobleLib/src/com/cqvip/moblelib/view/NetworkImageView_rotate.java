...
public class NetworkImageView_rotate extends ImageView {
    ...
    public NetworkImageView_rotate(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * NOTE: If applicable, {@link NetworkImageView_rotate#setDefaultImageResId(int)} and
     * {@link NetworkImageView_rotate#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
                ...
                new ImageListener() {
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                        	//Log.i("NetworkImageView_rotate", "response.getBitmap()");
                        	mContainer=(ViewGroup) getParent();
                        	readerinfo_f_lay=(ImageView) mContainer.findViewById(R.id.defaut_book_img);
