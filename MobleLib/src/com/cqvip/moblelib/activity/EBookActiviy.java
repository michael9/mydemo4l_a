...
public class EBookActiviy extends BaseActivity {
	...
	public static Map<Integer, Boolean> isSelected;//判断是否选中
	private Context context;
	
	private SharedPreferences userChoice;//保存用户选择
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = this;
		userChoice = getSharedPreferences("mobilelibszy", MODE_PRIVATE);
		...
		int choice = userChoice.getInt("userchoice", 0);
		adapter = new MyAdapter(this, EBOOKTYPE, drawableids,choice);
